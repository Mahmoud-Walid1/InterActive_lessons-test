...
├── lessons/                   # مجلدات تسليم الدروس مصنفة حسب الصفوف والمواد
│   ├── grade-1/ ... grade-6/ # الصف الأول حتى السادس
│   │   ├── science/          # مادة العلوم
│   │   ├── math/             # مادة الرياضيات
│   │   ├── arabic/           # مادة لغتي (اللغة العربية)
│   │   ├── studies/          # مادة الدراسات الاجتماعية
│   │   ├── english/          # مادة اللغة الإنجليزية
│   │   └── islamic/          # مادة الدراسات الإسلامية
├── preview/
...
2. توجّه إلى مجلد الصف والمادة المستهدفة داخل `lessons/` (مثال: `lessons/grade-2/science/` أو `lessons/grade-4/math/`).
3. الصق المجلد وأعد تسميته باسم الدرس بالإنجليزية (مثال: `living-things-needs` أو `fractions-intro`).
...
- `"subjectId"`: رمز المادة المعتمد:
  * `"science"`: العلوم
  * `"math"`: الرياضيات
  * `"arabic"`: لغتي (اللغة العربية)
